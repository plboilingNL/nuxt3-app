      ...
      <Popover class="relative bg-white">
        ...
        >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div
                          class="flex items-center justify-center flex-shrink-0 w-10 h-10 text-white rounded-md bg-gradient-to-r from-purple-600 to-indigo-600 sm:h-12 sm:w-12"
                        >
                          <component
                            :is="item.icon"
                            class="w-6 h-6"
          ...
          <div class="items-center justify-end hidden md:flex md:flex-1 lg:w-0">
            ...
            <a
              href="#"
              class="inline-flex items-center justify-center px-4 py-2 ml-8 text-base font-medium text-white border border-transparent rounded-md shadow-sm whitespace-nowrap bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border hover:from-purple-700 hover:to-indigo-700"
            >
              Sign up
            </a>
          </div>
              ...
              <div class="px-5 pt-5 pb-6">
                ...
                <div class="mt-6">
                  <nav class="grid grid-cols-1 gap-7">
                    ...
                    >
                      <div
                        class="flex items-center justify-center flex-shrink-0 w-10 h-10 text-white rounded-md bg-gradient-to-r from-purple-600 to-indigo-600"
                      >
                        <component
                          :is="item.icon"
                          class="w-6 h-6"
    ...
    <main>
      ...
      <div class="bg-gray-100">
        <div class="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div
            class="grid grid-cols-2 gap-8 mt-6 md:grid-cols-6 lg:grid-cols-5"
          >
            <div
              ...
              <div>
                ...
                <div class="mt-6">
                  ...
                  <div class="mt-6">
                    <a
                      href="#"
                      class="inline-flex px-4 py-2 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border hover:from-purple-700 hover:to-indigo-700"
                    >
                      Get started
                    </a>
                  </div>
        ...
        >
          ...
          >
            <h2 class="text-sm font-semibold tracking-wide uppercase">
              <span
                class="text-transparent bg-gradient-to-r from-purple-300 to-indigo-300 bg-clip-text"
      ...
      <div class="bg-white">
        ...
        >
          ...
          >
            ...
            <span
              class="block text-transparent bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text"
          ...
          <div class="mt-6 space-y-4 sm:space-y-0 sm:flex sm:space-x-5">
            <a
              href="#"
              class="flex items-center justify-center px-4 py-3 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border hover:from-purple-700 hover:to-indigo-700"
            >
              Learn more
            </a>
            <a
          ...
          <div class="mt-12 xl:mt-0">
            ...
            <form class="mt-4 sm:flex sm:max-w-md">
              ...
              <input
                ...
                autocomplete="email"
                required=""
                class="w-full min-w-0 px-4 py-2 text-base text-gray-900 placeholder-gray-500 bg-white border border-gray-300 rounded-md shadow-sm appearance-none focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:placeholder-gray-400"
